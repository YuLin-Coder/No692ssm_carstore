...
public class GoodsServiceImpl implements GoodsService {
	...
	@Override // 继承接口
	public List<Goods> getGoodsBySupplier(String supplierid) {
		return this.goodsDAO.getGoodsBySupplier(supplierid);
	}

	@Override // 继承接口
	public List<Goods> getGoodsByRacks(String racksid) {
		return this.goodsDAO.getGoodsByRacks(racksid);
	}
