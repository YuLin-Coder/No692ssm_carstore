...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>修改汽车类型信息</legend>
		</fieldset>
		<form id="addForm" class="layui-form" action="cate/updateCate.action"
			name="myform" method="post">
			<div class="layui-form-item">
				<label class="layui-form-label">类型名称</label>
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="catename" class="layui-input"
						id="catename" value="${cate.catename}" />
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="contents" class="layui-input"
						id="contents" value="${cate.contents}" />
				</div>
			</div>
			<div class="layui-form-item">
