...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title"
			...
			<legend>修改网站公告信息</legend>
		</fieldset>
		<form id="addForm" class="layui-form"
			action="article/updateArticle.action" name="myform" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 45%;">
					<input class="layui-input" type="text" name="image"
						value="${article.image}" id="image" onclick="selimage();"
						readonly="readonly" />
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="contents" class="layui-input"
						id="contents" value="${article.contents}" />
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-input-block">
					<input type="hidden" name="articleid" id="articleid"
						...
						name="addtime" id="addtime" value="${article.addtime}" /> <input
						type="hidden" name="hits" id="hits" value="${article.hits}" />
