	...
	<div class="admin-main">
		<blockquote class="layui-elem-quote">
			<span style="text-align: left">${html }</span> <span
				style="float: right"><a href="supplier/getAllSupplier.action"
				class="layui-btn layui-btn-small"> <i class="layui-icon">&#x1002;</i>&nbsp;刷新数据
			</a></span>
		</blockquote>
		<fieldset class="layui-elem-field">
			<legend>供应商数据列表</legend>
				...
				<table class="layui-table">
					...
					<c:forEach items="${supplierList}" var="supplier">
						<tr align="center">
							...
							<td>${supplier.contents}</td>
							<td><a
								href="supplier/getSupplierById.action?id=${supplier.supplierid}">编辑</a>&nbsp;&nbsp;<a
								href="supplier/deleteSupplier.action?id=${supplier.supplierid}"
