									...
									<c:forEach items="${itemsList}" var="orders" varStatus="st">
										<tr align="center" bgcolor="#ffffff">
											...
											<td><input type="radio" name="tnum_${st.index}" id="tnum" value="1"><img
												...
												name="tnum_${st.index}" id="tnum" value="2"><img src="themes/ecmoban_dangdang/images/stars2.gif" />
												&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="tnum_${st.index}" id="tnum" value="3"><img
												src="themes/ecmoban_dangdang/images/stars3.gif" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
												name="tnum_${st.index}" id="tnum" value="4"><img src="themes/ecmoban_dangdang/images/stars4.gif" />
