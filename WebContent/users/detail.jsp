		...
		<div class="AreaR">
				...
				<div class="textInfo">
					<form action="index/addcart.action" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
						...
						<ul class="ul2 clearfix">
							...
							<li class="clearfix" style="width: 100%">
								<dd>
									<strong>加入收藏：</strong><a href="index/addfav.action?id=${goods.goodsid }">加入收藏</a>
								</dd>
							</li>
							<li class="clearfix" style="width: 100%">
								<dd>
			...
			<div class="box">
				...
				<div class="box_1">
					...
					<div id="com_h">
						<blockquote>品牌：${goods.brand }; &nbsp;&nbsp;&nbsp;&nbsp;型号：${goods.type }; &nbsp;&nbsp;&nbsp;&nbsp;颜色：${goods.color }; &nbsp;&nbsp;&nbsp;&nbsp;尺寸：${goods.size }; &nbsp;&nbsp;&nbsp;&nbsp;座位数：${goods.seating }</blockquote>
					</div>
				</div>
			</div>
			<div class="blank"></div>
